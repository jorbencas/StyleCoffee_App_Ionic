...
export const environment = {
  production: false,
  apiKey: "AIzaSyBYROYMDyQ_oxJOEuluDB-c4RlWJMZ-WAE",
  authDomain: "clone-instagram-48a2f.firebaseapp.com",
  ...
  /*api_php_url: 'http://c2cffefa.ngrok.io/StyleCoffee_App_Server/index.php?module='*/
